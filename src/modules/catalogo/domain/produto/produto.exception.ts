...
class NomeProdutoTamanhoMinimoInvalido extends ProdutoException{
    public constructor(message: string =' o nome do produto não possui um tamanho mínimo valido'){
        super(message);
        this.name = 'NomeProdutotamanhoMininoInvalido';
        this.message = message;
    }
}

class NomeProdutoTamanhoMaximoInvalido extends ProdutoException{
    public constructor(message: string ='o nome do produto não possui um tamanho máximo valido'){
        super(message);
...
class QtdMaximaCategoriasProdutoInvalida extends ProdutoException {
    public constructor(message:string = '⚠️ A quantidade maximo de categorias do produto é inválida.') {
        super(message);
        this.name = 'QtdMinimaCategoriasProdutoInvalida'
        this.message = message;
    }
