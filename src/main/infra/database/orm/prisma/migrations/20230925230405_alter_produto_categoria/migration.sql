...
-- AddForeignKey
ALTER TABLE "produtos_categorias" ADD CONSTRAINT "produtos_categorias_categoria_id_fkey" FOREIGN KEY ("categoria_id") REFERENCES "categoria"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
